sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prototype.controller.Providers", {
			...
			if (status) {
				...
				return new Promise(function(fnResolve, fnReject) {
					...
					if (bHasPendingChanges) {
						...
						var oNewEntityInstance = Utilities.getDefaultValuesForCreateProvider();
						...
						this.doNavigate("CreateProvider", oNewBindingContext, fnResolve);
					}
				}.bind(this)).catch(function(err) {
					if (err !== undefined) {
						MessageBox.error(err.message);
		...
		onInit: function() {
			...
			this.oRouter.getTarget("Providers").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
