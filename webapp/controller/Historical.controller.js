sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prototype.controller.Historical", {
		...
		onInit: function() {
			...
			this.oRouter.getTarget("Historical").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_ListReport_ListReport_0-content-Fiori_ListReport_Table-1-udg4r3uokzfxv9xjy5u2foun3_S3",
				"groups": ["items"]
			}];
