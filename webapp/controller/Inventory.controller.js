sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prototype.controller.Inventory", {
		handleRouteMatched: function(oEvent) {
			var sAppId = "App627528cde0d59c01c02cec77";
		...
		_onFioriListReportActionButtonPress: function() {
			...
			if (status) {
				...
				return new Promise(function(fnResolve, fnReject) {
					...
					if (bHasPendingChanges) {
						...
						var oNewEntityInstance = Utilities.getDefaultValuesForPurchaseCreate();
						...
						this.doNavigate("PurchaseCreate", oNewBindingContext, fnResolve);
					}
		...
		_onFioriListReportActionButtonPress2: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("Providers", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		_onFioriListReportActionButtonPress3: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("Historical", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_ListReport_ListReport_0-filterBars-Fiori_ListReport_FilterBar-1-filters-Fiori_ListReport_ComboBoxFilter-1653624092399---1",
				"groups": ["items"]
			}, {
